...
describe('GenericSqlOpForm', () => {
    beforeEach(() => {
        ...
        httpGet.mockResolvedValue({ config: { sql_statement_1: '', sql_statement_2: '', input_models: [] } });
    ...
    it('handles form submission for edit action', async () => {
        const editProps = { ...defaultProps, action: 'edit', node: { id: 'nodeId', type: 'operation_node', data: { config: { input_models: [{ name: 'Test Input Model' }] } } } };
