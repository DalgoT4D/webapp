        ...
        runs: [
            {
                ...
                logs: [{ level: 1, message: 'Log message 1', timestamp: moment().toISOString() }],
            },
        ],
        status: 'COMPLETED',
    },
        ...
        runs: [
            {
                ...
                start_time: moment().subtract(2, 'hours').toISOString(),
                end_time: moment().toISOString(),
                logs: [{ level: 1, message: 'Log message 3', timestamp: moment().toISOString() }],
            },
        ],
        status: 'COMPLETED',
    },
        ...
        runs: [
            {
                ...
                start_time: moment().subtract(2, 'hours').toISOString(),
                end_time: moment().toISOString(),
                logs: [{ level: 1, message: 'Log message 4', timestamp: moment().toISOString() }],
            },
        ],
        status: 'COMPLETED',
    },
...
const mockPollResponse = {
    progress: [{ status: 'completed', result: [{ prompt: 'summary', response: 'This is the AI summary.' }] }],
};
                ...
                runs: [
                    {
                        ...
                        start_time: moment().subtract(2, 'hours').toISOString(),
                        end_time: moment().toISOString(),
                        logs: [{ level: 1, message: 'Log message 6', timestamp: moment().toISOString() }],
                    },
                ],
                status: 'COMPLETED',
            },
                ...
                runs: [
                    {
                        ...
                        start_time: moment().subtract(2, 'hours').toISOString(),
                        end_time: moment().toISOString(),
                        logs: [{ level: 1, message: 'Log message 7', timestamp: moment().toISOString() }],
                    },
                ],
                status: 'COMPLETED',
            },
                ...
                runs: [
                    {
                        ...
                        start_time: moment().subtract(2, 'hours').toISOString(),
                        end_time: moment().toISOString(),
                        logs: [{ level: 1, message: 'Log message 8', timestamp: moment().toISOString() }],
                    },
                ],
                status: 'COMPLETED',
            },
                ...
                runs: [
                    {
                        ...
                        start_time: moment().subtract(2, 'hours').toISOString(),
                        end_time: moment().toISOString(),
                        logs: [{ level: 1, message: 'Log message 9', timestamp: moment().toISOString() }],
                    },
                ],
                status: 'COMPLETED',
            },
