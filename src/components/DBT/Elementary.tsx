...
const elementaryStatuss = {
  exists: {
    elementary_package: 'elementary-data/elementary@0.16.1',
    elementary_target_schema: 'analytics_elementary',
  },
  missing: {
  ...
  - package: elementary-data/elementary
    ...
    elementary_target_schema: `models:
...
export const Elementary = () => {
  ...
  const [elementaryStatus, setElementaryStatus] = useState<ElementaryStatus | null>(
    elementaryStatuss
  );
