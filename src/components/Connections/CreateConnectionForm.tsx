...
const CreateConnectionForm = memo(
  ({ setConnectionId, connectionId, mutate, showForm, setShowForm }: CreateConnectionFormProps) => {
...
CreateConnectionForm.displayName = 'CreateConnectionForm';
