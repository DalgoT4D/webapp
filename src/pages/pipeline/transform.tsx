    ...
    if (session) {
        fetchTransformType().then((transformType) => {
          if (transformType === 'github') {
            window.location.href = '/workflow/github';
      ...
      <main className={styles.main}>
        ...
        <Grid container spacing={2} columns={12}>
          <Grid item xs={6}>
            ...
            >
              <Image src={Github} alt="github_transform" className={styles.image} />
          ...
          <Grid item xs={6}>
            <Box
              ...
              sx={{ padding: '30px' }}
            >
              <Image src={UI} alt="ui_transform" className={styles.image} />
