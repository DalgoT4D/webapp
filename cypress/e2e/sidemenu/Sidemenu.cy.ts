describe('Side menu', () => {
  ...
  it('Initial render of side menu', () => {
    ...
    cy.get('[data-testid="side-menu"]').contains('Data Analysis').should('be.visible');
  ...
  it.only('Switching between menu items', () => {
    ...
    cy.get('[data-testid="menu-item-5"]').click();
